...
# ------------------------------------------------------------------------
PROMPT_FILE = globals().get("PROMPT_FILE", "data/ReNeLLM/jailbreaks/stronger400.csv")
OUTPUT_DIR = globals().get("OUTPUT_DIR", "output/extractions/stronger")
...
LOG_FILE = globals().get("LOG_FILE", "logs/stronger_run_progress.log")
ERROR_LOG = globals().get("ERROR_LOG", "logs/stronger_run_errors.log")
