...
def plot_pca_scatter(pca_results, title="PCA Scatter Plot", save_path=None):
    ...
    In any case, the plot is displayed inline.
    """
...
def run_activation_evaluation(analysis_result_path, n_clusters=3, save_dir=None):
    ...
    This function:
      ...
      - Plots and saves (if save_dir is provided) the PCA scatter plots.
    ...
    # If save_dir is provided, create it and determine the save paths
    if save_dir:
    ...
    # Plot the PCA scatter plot (this will display inline and save if plt_path is provided)
